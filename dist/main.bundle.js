...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libComponentsApp = __webpack_require__(177);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      if (this.props.app.error) {
	        return _react2['default'].createElement(_libComponentsError2['default'], { message: this.props.app.error });
	      }
	      var addedComponents = [];
	      if (this.props.arrangement.exportedData) {
	        addedComponents.push(_react2['default'].createElement(_libComponentsExportedData2['default'], {
	          key: 'exported-data',
...
/***/ function(module, exports) {
	...
	var CLEAR_EXPORTED_DATA = 'CLEAR_EXPORTED_DATA';
	...
	exports.SET_CURRENT_PART = SET_CURRENT_PART;
	var SET_CURRENT_POSITION = 'SET_CURRENT_POSITION';
	exports.SET_CURRENT_POSITION = SET_CURRENT_POSITION;
	var SET_EXPORTED_DATA = 'SET_EXPORTED_DATA';
	exports.SET_EXPORTED_DATA = SET_EXPORTED_DATA;
	var SET_STATUS = 'SET_STATUS';
	exports.SET_STATUS = SET_STATUS;
	var TOUCH_NOTE = 'TOUCH_NOTE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dispatchCurrentChords(dispatch, state) {
	  ...
	  var position = part[arrangement.currentPosition] || {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialControlsState = {
	  chordInversion: 0,
	  chordType: 'M'
	};
	
	exports.initialControlsState = initialControlsState;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function arrangement(state, action) {
	  switch (action.type) {
	    case actionTypes.RESET_STATE:
